...
def plotColors(histogram, centroids):
	# initialize bar chart representing the relative frequency of each color
	bar = NumPy.zeros((50, 300, 3), dtype = "uint8") # returns a new array of given shape and type filled with 0s
	startX = 0
